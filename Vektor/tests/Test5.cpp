...
TEST_CASE("Testing move constructor MojVektor(MojVektor&&)") {
  // Create an original vector
  MojVektor original_v = {1, 2, 3, 4, 5};

  // Move the original vector to a new vector
  MojVektor new_v(std::move(original_v));
